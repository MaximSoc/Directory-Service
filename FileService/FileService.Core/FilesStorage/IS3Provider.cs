...
public interface IS3Provider
{
    ...
    Task<Result<string, Error>> GenerateDownloadUrlAsync(StorageKey key, CancellationToken cancellationToken = default, bool useExternalEndpoint = false);
    ...
    Task<Result<IReadOnlyList<ChunkUploadUrl>, Error>> GenerateAllChunksUploadUrls(
        StorageKey key,
        string uploadId,
        int totalChunks,
        CancellationToken cancellationToken = default,
